...
TESTS=(
    ...
    # - - - CL tests - - -
    confirmation_layer::node::test_regular_transactions
    ...
    confirmation_layer::node::test_set_block_interval
    confirmation_layer::node::test_invalid_block_interval
    confirmation_layer::node::test_chain_not_found
    confirmation_layer::node::test_chain_already_registered
    confirmation_layer::node::test_chain_registration
    confirmation_layer::node::test_block_interval_validation
    confirmation_layer::node::test_subblock_not_found
    confirmation_layer::node::test_get_registered_chains
    confirmation_layer::node::test_get_block_interval
    confirmation_layer::node::test_submit_transaction_chain_not_registered
    confirmation_layer::node::test_submit_cl_transaction_for_multiple_chains
    
    # - - - HIG tests - - -
    hyper_ig::node::test_regular_transaction_success
    hyper_ig::node::test_regular_transaction_failure
    hyper_ig::node::test_regular_transaction_pending
    hyper_ig::node::test_cat_success_proposal
    hyper_ig::node::test_cat_failure_proposal
    hyper_ig::node::test_get_pending_transactions
    hyper_ig::node::test_wrong_chain_subblock

    # - - - HS tests - - -
    hyper_scheduler::node::test_receive_success_proposal_first_message
    hyper_scheduler::node::test_receive_failure_proposal_first_message
    hyper_scheduler::node::test_duplicate_rejection
    hyper_scheduler::node::test_process_proposals_for_two_chain_cat
