...
def plot_pending_transactions():
    try:
        ...
        try:
            with open('simulator/results/sim_simple/data/cat_pending_transactions_chain_2.json', 'r') as f:
        ...
        try:
            with open('simulator/results/sim_simple/data/regular_pending_transactions_chain_2.json', 'r') as f:
        ...
        plt.grid(True)
        plt.legend()
        plt.savefig('simulator/results/sim_simple/figs/tx_count_pending_all_cats.png')
        plt.close()
...
def plot_success_transactions():
    try:
        ...
        try:
            with open('simulator/results/sim_simple/data/cat_success_transactions_chain_1.json', 'r') as f:
                chain_1_cat_data = json.load(f)
        ...
        try:
            with open('simulator/results/sim_simple/data/regular_success_transactions_chain_1.json', 'r') as f:
                chain_1_regular_data = json.load(f)
        ...
        try:
            with open('simulator/results/sim_simple/data/cat_success_transactions_chain_2.json', 'r') as f:
                chain_2_cat_data = json.load(f)
        ...
        try:
            with open('simulator/results/sim_simple/data/regular_success_transactions_chain_2.json', 'r') as f:
                chain_2_regular_data = json.load(f)
        ...
        plt.grid(True)
        plt.legend()
        plt.savefig('simulator/results/sim_simple/figs/tx_count_success_all_cats.png')
        plt.close()
...
def plot_failure_transactions():
    try:
        ...
        try:
            with open('simulator/results/sim_simple/data/cat_failure_transactions_chain_1.json', 'r') as f:
                chain_1_cat_data = json.load(f)
        ...
        try:
            with open('simulator/results/sim_simple/data/regular_failure_transactions_chain_1.json', 'r') as f:
                chain_1_regular_data = json.load(f)
        ...
        try:
            with open('simulator/results/sim_simple/data/cat_failure_transactions_chain_2.json', 'r') as f:
                chain_2_cat_data = json.load(f)
        ...
        try:
            with open('simulator/results/sim_simple/data/regular_failure_transactions_chain_2.json', 'r') as f:
                chain_2_regular_data = json.load(f)
        ...
        plt.grid(True)
        plt.legend()
        plt.savefig('simulator/results/sim_simple/figs/tx_count_failure_all_cats.png')
        plt.close()
