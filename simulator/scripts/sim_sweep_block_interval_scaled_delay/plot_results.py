...
def load_sweep_data():
    ...
    with open('simulator/results/sim_sweep_block_interval_scaled_delay/data/sweep_results.json', 'r') as f:
        return json.load(f)
...
def plot_pending_transactions_overlay():
    ...
    try:
        ...
        plt.tight_layout()
        plt.savefig('simulator/results/sim_sweep_block_interval_scaled_delay/figs/pending_transactions_overlay.png', 
...
def plot_success_transactions_overlay():
    ...
    try:
        ...
        plt.legend(bbox_to_anchor=(1.05, 1), loc='upper left')
        plt.tight_layout()
        plt.savefig('simulator/results/sim_sweep_block_interval_scaled_delay/figs/success_transactions_overlay.png', 
                   dpi=300, bbox_inches='tight')
        plt.close()
...
def plot_failure_transactions_overlay():
    ...
    try:
        ...
        plt.legend(bbox_to_anchor=(1.05, 1), loc='upper left')
        plt.tight_layout()
        plt.savefig('simulator/results/sim_sweep_block_interval_scaled_delay/figs/failure_transactions_overlay.png', 
                   dpi=300, bbox_inches='tight')
        plt.close()
...
def plot_sweep_summary():
    ...
    try:
        ...
        plt.tight_layout()
        plt.savefig('simulator/results/sim_sweep_block_interval_scaled_delay/figs/sweep_summary.png', 
                   dpi=300, bbox_inches='tight')
        plt.close()
...
def main():
    """Main function"""
    print("Generating block interval scaled delay sweep plots...")
    
    # Create results directory if it doesn't exist
    os.makedirs('simulator/results/sim_sweep_block_interval_scaled_delay/figs', exist_ok=True)
    ...
    print("Block interval scaled delay sweep plots generated successfully!")
