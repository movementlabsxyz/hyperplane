...
def plot_pending_transactions():
    try:
        with open('simulator/results/sim_simple_repeated/data/pending_transactions_chain_1.json', 'r') as f:
            chain_1_data = json.load(f)
        with open('simulator/results/sim_simple_repeated/data/pending_transactions_chain_2.json', 'r') as f:
        ...
        try:
            with open('simulator/results/sim_simple_repeated/data/cat_pending_transactions_chain_2.json', 'r') as f:
        ...
        try:
            with open('simulator/results/sim_simple_repeated/data/regular_pending_transactions_chain_2.json', 'r') as f:
        ...
        plt.grid(True)
        plt.legend()
        plt.savefig('simulator/results/sim_simple_repeated/figs/tx_count_pending_all_cats.png')
        plt.close()
...
def plot_success_transactions():
    try:
        with open('simulator/results/sim_simple_repeated/data/success_transactions_chain_1.json', 'r') as f:
            chain_1_data = json.load(f)
        with open('simulator/results/sim_simple_repeated/data/success_transactions_chain_2.json', 'r') as f:
            chain_2_data = json.load(f)
        ...
        try:
            with open('simulator/results/sim_simple_repeated/data/cat_success_transactions_chain_1.json', 'r') as f:
                chain_1_cat_data = json.load(f)
        ...
        try:
            with open('simulator/results/sim_simple_repeated/data/regular_success_transactions_chain_1.json', 'r') as f:
                chain_1_regular_data = json.load(f)
        ...
        try:
            with open('simulator/results/sim_simple_repeated/data/cat_success_transactions_chain_2.json', 'r') as f:
                chain_2_cat_data = json.load(f)
        ...
        try:
            with open('simulator/results/sim_simple_repeated/data/regular_success_transactions_chain_2.json', 'r') as f:
                chain_2_regular_data = json.load(f)
        ...
        plt.grid(True)
        plt.legend()
        plt.savefig('simulator/results/sim_simple_repeated/figs/tx_count_success_all_cats.png')
        plt.close()
...
def plot_failure_transactions():
    try:
        with open('simulator/results/sim_simple_repeated/data/failure_transactions_chain_1.json', 'r') as f:
            chain_1_data = json.load(f)
        with open('simulator/results/sim_simple_repeated/data/failure_transactions_chain_2.json', 'r') as f:
            chain_2_data = json.load(f)
        ...
        try:
            with open('simulator/results/sim_simple_repeated/data/cat_failure_transactions_chain_1.json', 'r') as f:
                chain_1_cat_data = json.load(f)
        ...
        try:
            with open('simulator/results/sim_simple_repeated/data/regular_failure_transactions_chain_1.json', 'r') as f:
                chain_1_regular_data = json.load(f)
        ...
        try:
            with open('simulator/results/sim_simple_repeated/data/cat_failure_transactions_chain_2.json', 'r') as f:
                chain_2_cat_data = json.load(f)
        ...
        try:
            with open('simulator/results/sim_simple_repeated/data/regular_failure_transactions_chain_2.json', 'r') as f:
                chain_2_regular_data = json.load(f)
        ...
        plt.grid(True)
        plt.legend()
        plt.savefig('simulator/results/sim_simple_repeated/figs/tx_count_failure_all_cats.png')
        plt.close()
