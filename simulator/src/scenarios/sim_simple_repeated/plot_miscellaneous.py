...
def plot_pending_transactions():
    try:
        with open('simulator/results/sim_simple_repeated/data/run_average/pending_transactions_chain_1.json', 'r') as f:
            chain_1_data = json.load(f)
        with open('simulator/results/sim_simple_repeated/data/run_average/pending_transactions_chain_2.json', 'r') as f:
        ...
        try:
            with open('simulator/results/sim_simple_repeated/data/run_average/cat_pending_transactions_chain_2.json', 'r') as f:
        ...
        try:
            with open('simulator/results/sim_simple_repeated/data/run_average/regular_pending_transactions_chain_2.json', 'r') as f:
        ...
        plt.grid(True)
        plt.legend()
        plt.savefig('simulator/results/sim_simple_repeated/figs/tx_count_pending_chain1.png')
        plt.close()
        ...
        plt.grid(True)
        plt.legend()
        plt.savefig('simulator/results/sim_simple_repeated/figs/tx_count_pending_chain2.png')
        plt.close()
        ...
        plt.grid(True)
        plt.legend()
        plt.savefig('simulator/results/sim_simple_repeated/figs/tx_count_pending_all.png')
        plt.close()
        ...
        plt.grid(True)
        plt.legend()
        plt.savefig('simulator/results/sim_simple_repeated/figs/tx_count_pending_cat.png')
        plt.close()
        ...
        plt.grid(True)
        plt.legend()
        plt.savefig('simulator/results/sim_simple_repeated/figs/tx_count_pending_regular.png')
        plt.close()
...
def plot_success_transactions():
    try:
        with open('simulator/results/sim_simple_repeated/data/run_average/success_transactions_chain_1.json', 'r') as f:
            chain_1_data = json.load(f)
        with open('simulator/results/sim_simple_repeated/data/run_average/success_transactions_chain_2.json', 'r') as f:
            chain_2_data = json.load(f)
        ...
        try:
            with open('simulator/results/sim_simple_repeated/data/run_average/cat_success_transactions_chain_1.json', 'r') as f:
                chain_1_cat_data = json.load(f)
        ...
        try:
            with open('simulator/results/sim_simple_repeated/data/run_average/regular_success_transactions_chain_1.json', 'r') as f:
                chain_1_regular_data = json.load(f)
        ...
        try:
            with open('simulator/results/sim_simple_repeated/data/run_average/cat_success_transactions_chain_2.json', 'r') as f:
                chain_2_cat_data = json.load(f)
        ...
        try:
            with open('simulator/results/sim_simple_repeated/data/run_average/regular_success_transactions_chain_2.json', 'r') as f:
                chain_2_regular_data = json.load(f)
        ...
        plt.grid(True)
        plt.legend()
        plt.savefig('simulator/results/sim_simple_repeated/figs/tx_count_success_chain1.png')
        plt.close()
        # Plot chain 2 only with CAT and regular breakdown
        plt.figure(figsize=(12, 6))
        ...
        plt.grid(True)
        plt.legend()
        plt.savefig('simulator/results/sim_simple_repeated/figs/tx_count_success_chain2.png')
        plt.close()
        # Plot both chains together (original combined plot)
        plt.figure(figsize=(12, 6))
        ...
        plt.grid(True)
        plt.legend()
        plt.savefig('simulator/results/sim_simple_repeated/figs/tx_count_success_all.png')
        plt.close()
        ...
        plt.grid(True)
        plt.legend()
        plt.savefig('simulator/results/sim_simple_repeated/figs/tx_count_success_cat.png')
        plt.close()
        ...
        plt.grid(True)
        plt.legend()
        plt.savefig('simulator/results/sim_simple_repeated/figs/tx_count_success_regular.png')
        plt.close()
...
def plot_failure_transactions():
    try:
        with open('simulator/results/sim_simple_repeated/data/run_average/failure_transactions_chain_1.json', 'r') as f:
            chain_1_data = json.load(f)
        with open('simulator/results/sim_simple_repeated/data/run_average/failure_transactions_chain_2.json', 'r') as f:
            chain_2_data = json.load(f)
        ...
        try:
            with open('simulator/results/sim_simple_repeated/data/run_average/cat_failure_transactions_chain_1.json', 'r') as f:
                chain_1_cat_data = json.load(f)
        ...
        try:
            with open('simulator/results/sim_simple_repeated/data/run_average/regular_failure_transactions_chain_1.json', 'r') as f:
                chain_1_regular_data = json.load(f)
        ...
        try:
            with open('simulator/results/sim_simple_repeated/data/run_average/cat_failure_transactions_chain_2.json', 'r') as f:
                chain_2_cat_data = json.load(f)
        ...
        try:
            with open('simulator/results/sim_simple_repeated/data/run_average/regular_failure_transactions_chain_2.json', 'r') as f:
                chain_2_regular_data = json.load(f)
        ...
        plt.grid(True)
        plt.legend()
        plt.savefig('simulator/results/sim_simple_repeated/figs/tx_count_failure_chain1.png')
        plt.close()
        # Plot chain 2 only with CAT and regular breakdown
        plt.figure(figsize=(12, 6))
        ...
        plt.grid(True)
        plt.legend()
        plt.savefig('simulator/results/sim_simple_repeated/figs/tx_count_failure_chain2.png')
        plt.close()
        # Plot both chains together (original combined plot)
        plt.figure(figsize=(12, 6))
        ...
        plt.grid(True)
        plt.legend()
        plt.savefig('simulator/results/sim_simple_repeated/figs/tx_count_failure_all.png')
        plt.close()
        ...
        plt.grid(True)
        plt.legend()
        plt.savefig('simulator/results/sim_simple_repeated/figs/tx_count_failure_cat.png')
        plt.close()
        ...
        plt.grid(True)
        plt.legend()
        plt.savefig('simulator/results/sim_simple_repeated/figs/tx_count_failure_regular.png')
        plt.close()
...
def plot_parameters():
    ...
    with open('simulator/results/sim_simple_repeated/figs/parameters.txt', 'w') as f:
