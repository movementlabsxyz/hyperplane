...
pub async fn run_all_tests() -> Result<(), crate::config::ConfigError> {
    ...
    crate::run_simple_simulation().await.map_err(|e| crate::config::ConfigError::ValidationError(e.to_string()))?;
    ...
    crate::run_sweep_cat_rate_simulation().await?;
    ...
    crate::run_sweep_zipf_simulation().await.map_err(|e| crate::config::ConfigError::ValidationError(e.to_string()))?;
    ...
    crate::run_sweep_chain_delay().await.map_err(|e| crate::config::ConfigError::ValidationError(e.to_string()))?;
    ...
    crate::run_sweep_cat_lifetime_simulation().await?;
