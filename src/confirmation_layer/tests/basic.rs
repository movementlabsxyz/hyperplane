...
async fn test_basic_confirmation_layer() {
    ...
    let (_, cl_node, mut _hig_node,_,_start_block_height) = testnodes::setup_test_nodes(Duration::from_millis(100)).await;
...
async fn test_block_interval() {
    ...
    let (_, cl_node, _,_,_start_block_height) = testnodes::setup_test_nodes(Duration::from_secs(1)).await;
...
async fn test_regular_transactions() {
    ...
    let (_, mut cl_node,  _hig_node,_,_start_block_height) = testnodes::setup_test_nodes(Duration::from_millis(100)).await;
...
async fn test_register_chain() {
    ...
    let (_, mut cl_node, _,_,_start_block_height) = testnodes::setup_test_nodes(Duration::from_millis(100)).await;
...
async fn test_get_current_block() {
    ...
    let (_, cl_node, _,_,_start_block_height) = testnodes::setup_test_nodes(Duration::from_millis(100)).await;
...
async fn test_submit_cl_transaction_for_multiple_chains() {
    ...
    let (_, mut cl_node, _,_,start_block_height) = testnodes::setup_test_nodes(Duration::from_millis(100)).await;
